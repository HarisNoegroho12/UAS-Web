    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p>Made by <a href="http://instagram.com/dimasfirmansyxx">Haris Noegroho</a> &copy; <span id="year-cred"></span></p>
            </div>
            <div class="col-sm-6 text-right">
              <p>UAS <a href="https://bootstrapious.com" class="external">2021</a></p>
            </div>
          </div>
        </div>
      </footer>
